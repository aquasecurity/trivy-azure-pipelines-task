...
function renderSecretSeverity(
  rowIndex: number,
  columnIndex: number,
  tableColumn: ITableColumn<ListSecret>,
  tableItem: ListSecret
): JSX.Element {
...
export class SecretsTable extends React.Component<SecretsTableProps> {
  private readonly results: ObservableArray<ListSecret> =
    new ObservableArray<ListSecret>([]);
  ...
  render() {
    ...
    return this.results.length == 0 ? (
      <ZeroData
        ...
        secondaryText={<span>No secrets were found for this scan target.</span>}
        imageAltText="trivy"
