...
function renderMisconfigurationSeverity(
  rowIndex: number,
  columnIndex: number,
  tableColumn: ITableColumn<ListMisconfiguration>,
  tableItem: ListMisconfiguration
): JSX.Element {
...
export class MisconfigurationsTable extends React.Component<MisconfigurationsTableProps> {
  private readonly results: ObservableArray<ListMisconfiguration> =
    new ObservableArray<ListMisconfiguration>([]);
...
function convertMisconfigurations(results: Result[]): ListMisconfiguration[] {
  ...
  results.forEach((result) => {
    if (
      ...
      result.Misconfigurations.forEach(function (
        misconfiguration: Misconfiguration
      ) {
        output.push({
          ...
          ID: {
            ...
            href:
              ...
              misconfiguration.ID.toLowerCase(),
            hrefTarget: '_blank',
            hrefRel: 'noopener',
            iconProps: {
